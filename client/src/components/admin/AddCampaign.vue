            ...
            <v-container class="my-5">
                <v-layout row wrap >
                        ...
                        <v-flex xs12 md6>
                                ...
                                <center><v-text-field style="width:70%; text-align: center;" label="ชื่อแคมเปญ"></v-text-field></center>
                                <br><br>
                                <center><v-text-field type="date" style="width:70%;" label="วันสิ้นสุดแคมเปญ"></v-text-field></center>
                                <br><br>
