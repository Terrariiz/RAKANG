...
data-merchantid="M031001" :data-amount=top data-orderno="00000001" :data-customerid=id
...
mounted() {
      ...
      recaptchaScript.setAttribute('src', 'https://sandbox-cdnv3.chillpay.co/js/widgets.js?v=1.00" charset="utf-8"')
